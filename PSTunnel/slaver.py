...
def main_slaver(proxy_info):
    communicate_addr = split_host(proxy_info["communicate_addr"])  # "127.0.0.1:57327"
    target_addr = split_host(proxy_info["target_addr"])  # "127.0.0.1:9011"
    set_secretkey('shootback')
    max_spare_count = 5
